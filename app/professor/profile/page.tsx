...
export default function ProfessorProfilePage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      {/* Hero Banner: Either Loading Skeleton OR Hydrated Data */}
      {isLoading ? (
        <div className="p-6 md:p-8 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6 animate-pulse">
          ...
          <div className="h-14 w-32 bg-slate-800 rounded-2xl" />
        </div>
      ) : profile ? (
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-300 font-medium">
                {profile.facultyName || 'Academic Faculty'}
              </p>
            </div>
          </div>
      ...
      {/* Main Content Area */}
      {isLoading ? (
        /* Unified Skeleton Loaders */
        <div className="space-y-6 animate-pulse">
          <div className="p-6 md:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 md:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 space-y-4">
        ...
        <div className="p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 text-center space-y-3">
          ...
          <p className="text-xs text-slate-400">
            Could not resolve your professor identity details. Please check your session or try again.
          </p>
          <button
            onClick={() => fetchProfileData(true)}
            className="px-4 py-2 rounded-xl bg-emerald-600 text-white text-xs font-bold shadow-sm hover:bg-emerald-700 transition-all"
          >
            Retry Loading
          </button>
        </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-900 dark:text-white">
                    Personal Information &amp; Assigned Modules
                  </h2>
                  <p className="text-[11px] font-medium text-slate-400">
                    Your institutional identity and clinical module responsibilities
                  </p>
                </div>
              </div>
              ...
              {assignedModules.length === 0 ? (
                <div className="p-6 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/60 dark:border-slate-700/60 text-center space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-400">
                    Your faculty dean assigns clinical modules to professors. Once assigned, they will appear here.
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
